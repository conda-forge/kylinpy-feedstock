...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kylinpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12012&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kylinpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kylinpy` can be installed with:

```
conda install kylinpy
```

It is possible to list all of the versions of `kylinpy` available on your platform with:
